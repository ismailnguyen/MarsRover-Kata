...
namespace MarsRover_Kata.Tests
{
    public class RoverTest
    {
        ...
        [TestCase(0, 0, Direction.North, "0,0,East")]
        [TestCase(0, 0, Direction.South, "0,0,West")]
        [TestCase(0, 0, Direction.East, "0,0,South")]
        [TestCase(0, 0, Direction.West, "0,0,North")]
        public void Should_Rover_Turn_Right(int x, int y, Direction direction, string expectedPosition)
        {
            // GIVEN
            Rover rover = new Rover(x, y, direction);
